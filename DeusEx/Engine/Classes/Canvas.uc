...
// DEUS_EX AJY
// SW-- MedFont and BigFont replaced with SmallFont, source art not available.
#exec Font Import File=Textures\SmallFont.bmp Name=MedFont
#exec Font Import File=Textures\SmallFont.bmp Name=BigFont
